...
//  SmallWeChat
//
//  Created by xiaohaiping on 16/5/22.//  Copyright © 2016年 HaoHe. All rights reserved.
//
...
class ImageDisplayView: UIView , UIScrollViewDelegate , GestureImageViewDelegate{
    ...
    class func show(images: [AnyObject] ,
                    index: Int ,
                    item: UIView ,
                    column: Int) -> ImageDisplayView {
        return ImageDisplayView(frame: UIScreen.mainScreen().bounds,
                                    images: images ,
                                    index: index,
    ...
    func GestureImageViewExit() {
        ...
        self.currentImageView = subView.viewWithTag(kImageViewTag) as! GestureImageView;
