...
#define NULLSTRING @""
@interface HealthKnowledgeModel : NSObject

@property (copy,nonatomic) NSNumber *ids;          //<<<分类id，需要查询该类下的列表就需要传入才参数
...
@property (copy,nonatomic) NSNumber *seq;          //<<<分类的排序，从小到大的递增排序
